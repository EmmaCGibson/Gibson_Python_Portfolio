...
```python
df.columns = ['year', 'rank', 'compnay', 'revenue', 'profit']
```
...
```
    ...
    <ipython-input-34-16dd37784a6c> in <module>
...
```python
# We can also do calculations insdie the print function
...
```python
max_infalmmation_20 = numpy.amax(data, axis = 0)[20]

if max_inflammation_0 == 0 and max_inflammation_20 == 20:
    print('Saspitious looking maxima!')
...
def explicit_fahr_to_celsius(temp):
    ...
    # Return the valuses of the new variable
    return converted
```
...
def fahr_to_celsius(temp):
    ...
    # explicit in explaining how the return command wokrs.
    return((temp - 32) * (5/9))
```
...
# return a new array contiant the original data with its mean offset to match the sedired value/
...
def offset_mean(data, target_mean_value = 0.0):
    ...
    with its mean offset ot match the desired value.
...
```
    ...
    <ipython-input-24-517455132804> in <module>
         14         sample_sum += value
         15 
    ---> 16 sample_mean = sample_sum / len(sample)
         17 
         18 sum_squared_devs = 0


    NameError: name 'sample_sum' is not defined
...
```
    ...
    <ipython-input-1-3531183c4fba> in <module>
          2 total = 0.0
...
def normalize_rectangle(rect):
    ...
    input should be in the formal (x0, y0, x1, y1).
...
```python
# Prompt the user to endter the input RNA file name
